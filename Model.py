...
def createModel():
    ...
    for di in range(0, 5400, smoothing_window_size):
    ...
    # Do several tensor transformations, because the function dynamic_rnn requires the output to be of a specific format
    ...
    test_points_seq = np.arange(5400, 7200, 50).tolist()
    ...
    # best_prediction_epoch = 28  # epoch with the best results when running the plotting code
    #
    ...
    return N, run_avg_predictions, zip(x_axis_seq, predictions_over_time[3])
